...
const App: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className={`relative z-10 w-[95%] max-w-2xl bg-white/90 backdrop-blur-md rounded-[3rem] hand-drawn-border shadow-2xl transition-all duration-700 overflow-y-auto max-h-[95vh]`}
        style={{ 
